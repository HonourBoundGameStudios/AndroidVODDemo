...
val MaxOnSecondaryDark = Color.White      // Text/icons on MaxPinkAccent (if it's used as a secondary container)
val MaxOnBackgroundDark = Color(0xFFE0E0E0) // Primary text on MaxBackgroundDark (slightly off-white)
val MaxOnSurfaceDark = Color(0xFFE0E0E0)     // Text/icons on MaxSurfaceDark
val MaxOutlineDark = Color(0xFF444444)      // For borders, dividers
val MaxWhite = Color(0xFFFFFFFF)
